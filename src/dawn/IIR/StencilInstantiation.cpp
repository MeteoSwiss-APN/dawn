...
//public:
//  StencilDescStatementMapper(StencilInstantiation* instantiation, sir::Stencil* sirStencil,
...
//    scope_.push(
//        std::make_shared<Scope>(sirStencil->Name, instantiation->getStencilDescStatements()));
//    scope_.top()->LocalFieldnameToAccessIDMap = instantiation->getMetaData().NameToAccessIDMap_;
...
//        make_unique<Stencil>(*instantiation_,
//                             sirStencil_->Attributes /* instantiation_->getSIRStencil()*/,
//                             StencilID),
...
//    StatementMapper statementMapper(sir_, instantiation_, scope_.top()->StackTrace, doMethod,
...
//  // Process the data from the SIR:
//  metadata_.stencilName_ = SIRStencil->Name;
//  metadata_.fileName_ = SIR->Filename;
//  metadata_.stencilLocation_ = SIRStencil->Loc;
...
//  StencilDescStatementMapper stencilDeclMapper(this, SIRStencil,
//                                               SIR); /*getName(), metadata_.stencilDescStatements_,
...
std::shared_ptr<StencilInstantiation> StencilInstantiation::clone() const {
  ...
  stencilInstantiation->metadata_.BoundaryConditionToExtentsMap_ =
      metadata_.BoundaryConditionToExtentsMap_;
...
const std::string StencilInstantiation::getName() const { return metadata_.stencilName_;}//SIRStencil_->Name; }
