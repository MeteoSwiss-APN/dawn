...
//    IDToStencilCallMap_.emplace(pair.first,
//    std::make_shared<StencilCallDeclStmt>(*(pair.second)));
//  }
...
//  //  std::cout << "expr added to the map, size is now: " << ExprToAccessIDMap_.size() <<
//  std::endl;
//}
...
// std::shared_ptr<StencilFunctionInstantiation>
// StencilMetaInformation::getStencilFunctionInstantiationCandidate(const std::string
// stencilFunName) {
//  auto it = std::find_if(stencilFunInstantiationCandidate_.begin(),
//                         stencilFunInstantiationCandidate_.end(),
//                         [&](std::pair<std::shared_ptr<StencilFunctionInstantiation>,
...
// std::shared_ptr<StencilFunctionInstantiation>
// StencilMetaInformation::cloneStencilFunctionCandidate(
...
//  auto sirStencilFun =
//  std::make_shared<sir::StencilFunction>(*(stencilFun->getStencilFunction()));
