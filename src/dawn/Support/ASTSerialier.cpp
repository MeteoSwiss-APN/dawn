...
using namespace dawn;
 ...
 void setLocation(dawn::proto::statements::SourceLocation* locProto,
 ...
 void setInterval(dawn::proto::statements::Interval* intervalProto,
 ...
 void setDirection(dawn::proto::statements::Direction* directionProto, const sir::Direction* direction)
 {
 ...
 void setField(dawn::proto::statements::Field* fieldProto, const sir::Field* field) {
  ...
  ProtoStmtBuilder::ProtoStmtBuilder(dawn::proto::statements::Stmt* stmtProto) { currentStmtProto_.push(stmtProto); }
...
BuiltinTypeID makeBuiltinTypeID(const proto::statements::BuiltinType& builtinTypeProto) {
  ...
  std::shared_ptr<sir::Direction> makeDirection(const proto::statements::Direction&
 directionProto) {
  ...
  std::shared_ptr<sir::Interval> makeInterval(const proto::statements::Interval&
 intervalProto) {
