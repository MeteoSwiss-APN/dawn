...
public:
  ...
  virtual void
  visit(const std::shared_ptr<BoundaryConditionDeclStmt> &stmt) = 0;
...
public:
  ...
  virtual void
  visit(const std::shared_ptr<VerticalRegionDeclStmt> &stmt) override;
  virtual void visit(const std::shared_ptr<StencilCallDeclStmt> &stmt) override;
  virtual void
  visit(const std::shared_ptr<BoundaryConditionDeclStmt> &stmt) override;
