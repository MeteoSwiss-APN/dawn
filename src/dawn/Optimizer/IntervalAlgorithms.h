...
/// @brief substracts two intervals, generating as a result a multiinterval
MultiInterval substract(const Interval& int1, const Interval& int2);
/// @brief substract one multi-interval from an interval
...
/// accesses to data that is computed within the stencil in iterative solvers), i.e. for
/// Do(kstart,kend)
