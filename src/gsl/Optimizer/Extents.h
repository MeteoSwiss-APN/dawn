...
#ifndef GSL_OPTIMIZER_EXTENTS_H
#define GSL_OPTIMIZER_EXTENTS_H
...
template <>
struct hash<gsl::Extents> {
  size_t operator()(const gsl::Extents& extent) const {
    size_t hash = 0;
    gsl::hash_combine(hash, extent[0].Minus, extent[0].Plus, extent[1].Minus, extent[1].Plus,
