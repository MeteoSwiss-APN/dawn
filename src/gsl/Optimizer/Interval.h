...
#ifndef GSL_OPTIMIZER_INTERVAL_H
#define GSL_OPTIMIZER_INTERVAL_H
...
template <>
struct hash<gsl::Interval> {
  size_t operator()(const gsl::Interval& I) const {
    std::size_t hash = 0;
    gsl::hash_combine(hash, I.lowerLevel(), I.lowerOffset(), I.upperLevel(), I.upperOffset());
    return hash;
  }
};
