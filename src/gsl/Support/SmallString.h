...
//===------------------------------------------------------------------------------------------===//
//
// This file is a port of LLVM's SmallString
//
//===------------------------------------------------------------------------------------------===//

#ifndef GSL_SUPPORT_SMALLSTRING_H
#define GSL_SUPPORT_SMALLSTRING_H
...
public:
  ...
  /// Check for string equality. This is more efficient than compare() when the relative ordering
  /// of inequal strings isn't needed.
