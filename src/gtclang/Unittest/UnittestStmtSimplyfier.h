...
public:
  ...
  template <typename... Args>
  const std::vector<std::shared_ptr<dawn::Stmt>>&
  createVec(const std::shared_ptr<dawn::Expr>& expr, Args&&... args) {
...
std::shared_ptr<dawn::VarDeclStmt> vecdec(const std::string& type, const std::string& name,
                                    std::vector<std::shared_ptr<dawn::Expr>> initList, int dimension = 0,
                                    const char* op = "=");
...
std::shared_ptr<dawn::VarAccessExpr> var(const std::string& name, std::shared_ptr<dawn::Expr> index = nullptr);
std::shared_ptr<dawn::FieldAccessExpr> field(const std::string& name, dawn::Array3i offset = dawn::Array3i{{0, 0, 0}},
                                       dawn::Array3i argumentMap = dawn::Array3i{{-1, -1, -1}},
                                       dawn::Array3i argumentOffset = dawn::Array3i{{0, 0, 0}},
