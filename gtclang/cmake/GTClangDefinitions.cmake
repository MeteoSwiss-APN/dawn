...
# Building configs
set(GTCLANG_DSL_INCLUDES "${GTCLANG_SOURCE_DIR}/src" "${CMAKE_INSTALL_PREFIX}/include")

# Testing configs
set(GTCLANG_EXECUTABLE "${CMAKE_BINARY_DIR}/bin/gtclang")
set(GTCLANG_UNITTEST_DATAPATH ${GTCLANG_BINARY_DIR}/test/unit-test)
set(GTCLANG_INTEGRATIONTEST_DATAPATH ${GTCLANG_BINARY_DIR}/test/integration-test)
set(GTCLANG_UNITTEST_INCLUDES ${GTCLANG_SOURCE_DIR}/src)
