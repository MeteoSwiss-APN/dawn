...
public:
  void push_back(const T& Elt) {
    if(DAWN_BUILTIN_UNLIKELY(this->EndX >= this->CapacityX))
      this->grow();
...
public:
  ...
  iterator erase(const_iterator CI) {
    ...
    DAWN_ASSERT(I >= this->begin() && "Iterator to erase is out of bounds.");
    DAWN_ASSERT(I < this->end() && "Erasing at past-the-end iterator.");
  ...
  iterator erase(const_iterator CS, const_iterator CE) {
    ...
    DAWN_ASSERT_MSG(S >= this->begin(), "Range to erase is out of bounds.");
    DAWN_ASSERT_MSG(S <= E, "Trying to erase invalid range.");
    DAWN_ASSERT_MSG(E <= this->end(), "Trying to erase past the end.");
  ...
  iterator insert(iterator I, T&& Elt) {
    ...
    DAWN_ASSERT_MSG(I >= this->begin(), "Insertion iterator is out of bounds.");
    DAWN_ASSERT_MSG(I <= this->end(), "Inserting past the end of the vector.");
