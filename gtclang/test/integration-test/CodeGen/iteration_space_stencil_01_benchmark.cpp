...
#include "test/integration-test/CodeGen/generated/iteration_space_stencil_01_c++-naive.cpp"
...
// clang-format off
#include INCLUDE_FILE(test/integration-test/CodeGen/generated/iteration_space_stencil_01_,OPTBACKEND.cpp)
// clang-format on
...
TEST(iteration_space_stencil, test) {
  ...
  dawn_generated::OPTBACKEND::iteration_space_stencil_01 iteration_space_gt(dom);
  dawn_generated::cxxnaive::iteration_space_stencil_01 iteration_space_naive(dom);
