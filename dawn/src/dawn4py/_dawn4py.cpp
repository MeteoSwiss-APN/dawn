      ...
      .def(
          py::init(
              [](int MaxBlocksPerSM, int nsms, int DomainSizeI, int DomainSizeJ, int DomainSizeK,
                 bool UseParallelEP, const std::string& Backend, const std::string& OutputFile,
                 bool SerializeIIR, const std::string& DeserializeIIR, const std::string& IIRFormat,
                 int MaxHaloPoints, const std::string& ReorderStrategy, int MaxFieldsPerStencil,
                 bool MaxCutMSS, int BlockSizeI, int BlockSizeJ, int BlockSizeK, bool SplitStencils,
                 bool MergeDoMethods, bool DisableKCaches, bool UseNonTempCaches, bool KeepVarnames,
                 bool PassVerbose, bool ReportAccesses, bool DumpSplitGraphs, bool DumpStageGraph,
                 bool DumpTemporaryGraphs, bool DumpRaceConditionGraph,
                 bool DumpStencilInstantiation, bool DumpStencilGraph, bool SSA,
                 bool PrintStencilGraph, bool SetStageName, bool StageReordering, bool StageMerger,
                 bool TemporaryMerger, bool Inlining, bool IntervalPartitioning,
          ...
          py::arg("use_parallel_ep") = false, py::arg("backend") = "gridtools",
          py::arg("output_file") = "", py::arg("serialize_iir") = false,
          py::arg("deserialize_iir") = "", py::arg("iir_format") = "json",
          ...
          py::arg("report_pass_remove_scalars") = false, py::arg("report_pass_stage_split") = false,
