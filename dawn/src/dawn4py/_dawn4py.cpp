      ...
      .def(
          py::init(
              [](int MaxBlocksPerSM, int nsms, int DomainSizeI, int DomainSizeJ, int DomainSizeK,
                 ...
                 const std::string& DeserializeIIR, const std::string& IIRFormat, int MaxHaloPoints,
                 const std::string& ReorderStrategy, int MaxFieldsPerStencil, bool MaxCutMSS,
                 int BlockSizeI, int BlockSizeJ, int BlockSizeK, bool DefaultNone, bool Parallel,
          ...
          py::arg("block_size_k") = 0, py::arg("default_none") = false, py::arg("parallel") = false,
          ...
          py::arg("data_locality_metric") = false, py::arg("split_stencils") = false,
