...
ASTVISITORFORWARDING_VISIT_IMPL(LoopStmt)
...
ASTVISITORFORWARDING_VISIT_IMPL(ReductionOverNeighborExpr)
...
ASTVISITORFORWARDINGNONCONST_VISIT_IMPL(LoopStmt)
...
ASTVISITORFORWARDINGNONCONST_VISIT_IMPL(ReductionOverNeighborExpr)
...
ASTVISITORPOSTORDER_VISIT_IMPL(Stmt, LoopStmt)
...
ASTVISITORPOSTORDER_VISIT_IMPL(Expr, ReductionOverNeighborExpr)
...
ASTVISITORDISABLED_VISIT_IMPL(LoopStmt)
...
ASTVISITORDISABLED_VISIT_IMPL(ReductionOverNeighborExpr)
