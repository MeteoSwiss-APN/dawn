...
__global__ void __launch_bounds__(32)
    copy_stencil_stencil11_ms19_kernel(const int isize, const int jsize, const int ksize,
                                       const int stride_111_1, const int stride_111_2,
                                       gridtools::clang::float_type* const in,
                                       gridtools::clang::float_type* const out) {
...
public:
  ...
  public:
    stencil_11(const gridtools::clang::domain& dom_, storage_ijk_t& in_, storage_ijk_t& out_)
    ...
    void run(storage_ijk_t in_ds, storage_ijk_t out_ds) {
      ...
      start();
      {
        ...
        copy_stencil_stencil11_ms19_kernel<<<blocks, threads>>>(
...
public:
  ...
  copy_stencil(const gridtools::clang::domain& dom, storage_ijk_t& in, storage_ijk_t& out)
      : m_stencil_11(new stencil_11(dom, in, out)) {}
