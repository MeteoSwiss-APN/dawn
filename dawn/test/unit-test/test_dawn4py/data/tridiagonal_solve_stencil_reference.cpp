...
namespace cuda {
__global__ void __launch_bounds__(32) tridiagonal_solve_stencil_stencil49_ms105_kernel(
...
__global__ void __launch_bounds__(32) tridiagonal_solve_stencil_stencil49_ms106_kernel(
    const int isize, const int jsize, const int ksize, const int stride_111_1,
  ...
  public:
    ...
    void run(storage_ijk_t a_ds, storage_ijk_t b_ds, storage_ijk_t c_ds, storage_ijk_t d_ds) {
      ...
      start();
      {
        ...
        tridiagonal_solve_stencil_stencil49_ms105_kernel<<<blocks, threads>>>(
      ...
      };
      {
        ...
        const unsigned int nbz = 1;
        dim3 blocks(nbx, nby, nbz);
        tridiagonal_solve_stencil_stencil49_ms106_kernel<<<blocks, threads>>>(
