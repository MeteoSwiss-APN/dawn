...
TEST_F(TestPassSetStageLocationType, CopyTwoLocationType) {
...
TEST_F(TestPassSetStageLocationType, CopyTwoLocationTypeVars) {
  // field(cells) in_cell;
  // field(edges) in_edge;
  // var out_var_cell;
  // var out_var_edge;
...
TEST_F(TestPassSetStageLocationType, IfStmt) {
  ...
  runPass("input/SplitStageByLocationType/split_stage_by_location_type_test_stencil_03.sir");
...
// TEST_F(TestPassSetStageLocationType, Tridiagonal) {
//   // field(cells) in_cell;
//   // field(edges) in_edge;
//   // var out_var_cell;
//   // var out_var_edge;
