...
def copy_fields():
    outputfile = "test_set_stage_location_type_copy_fields.sir"
...
def copy_vars():
    outputfile = "test_set_stage_location_type_copy_vars.sir"
...
def if_stmt():
    outputfile = "test_set_stage_location_type_if_stmt.sir"
