...
TEST(TestField, Equal) {
  ...
  Field f1{1, Field::IntendKind::IK_Input, Extents(dawn::ast::cartesian_{}, -1, 1, -2, 2, 0, 3),
           Extents(dawn::ast::cartesian_{}, 0, 0, 0, 0, -1, 2), Interval{0, 2, 1, -2}};

  Field f2{1, Field::IntendKind::IK_Input, Extents(dawn::ast::cartesian_{}, -1, 1, -1, 2, 0, 3),
           Extents(dawn::ast::cartesian_{}, 0, 0, 1, 0, -1, 2), Interval{0, 2, 1, 0}};

  Field f3{1, Field::IntendKind::IK_InputOutput,
           Extents(dawn::ast::cartesian_{}, -1, 1, -2, 2, 0, 3),
           Extents(dawn::ast::cartesian_{}, 0, 0, 0, 0, -1, 2), Interval{0, 2, 1, -2}};
  Field f4{2, Field::IntendKind::IK_Input, Extents(dawn::ast::cartesian_{}, -1, 1, -2, 2, 0, 3),
           Extents(dawn::ast::cartesian_{}, 0, 0, 0, 0, -1, 2), Interval{0, 2, 1, -2}};
...
TEST(TestField, Merge) {
  ...
  f.mergeReadExtents(Extents(dawn::ast::cartesian_{}, -2, 1, -3, 0, 0, 0));
  EXPECT_TRUE((f.getReadExtents() == Extents(dawn::ast::cartesian_{}, -2, 1, -3, 2, 0, 3)));
  EXPECT_TRUE((f.getWriteExtents() == Extents(dawn::ast::cartesian_{}, 0, 0, 0, 0, -1, 2)));
  EXPECT_TRUE((f.getExtents() == Extents(dawn::ast::cartesian_{}, -2, 1, -3, 2, -1, 3)));
} // namespace
} // anonymous namespace
