  ...
  */
  ...
  auto instantiation = b.build(
      "Test", b.stencil(b.multistage(
                  ...
                  b.stage(b.doMethod(dawn::ast::Interval::Start, dawn::ast::Interval::Start, 0, 12,
  ...
  EXPECT_EQ(field.getInterval(),
            (iir::Interval{ast::Interval::Start, ast::Interval::Start, 0, 12}));
}
  ...
  */
  ...
  auto instantiation = b.build(
      ...
      b.stencil(
          ...
          b.multistage(
              iir::LoopOrderKind::Forward,
              b.stage(b.doMethod(dawn::ast::Interval::End, dawn::ast::Interval::End,
  ...
  auto fieldToIDMap = stencils[0]->getFields();
  auto field = fieldToIDMap.at(inID).field;
  EXPECT_EQ(field.getInterval(), (iir::Interval{ast::Interval::Start, ast::Interval::End, 0, 0}));
}
...
TEST(TestFieldAccessIntervals, test_field_access_interval_03) {
  ...
  */
  ...
  auto instantiation = b.build(
      "Test", b.stencil(b.multistage(
                  iir::LoopOrderKind::Forward,
                  b.stage(b.doMethod(dawn::ast::Interval::Start, dawn::ast::Interval::Start, 0, 2,
                                     b.block(b.stmt(b.assignExpr(b.at(in_f), b.lit(12.)))))))));
  ...
  auto fieldToIDMap = stencils[0]->getFields();
  auto field = fieldToIDMap.at(inID).field;
  EXPECT_EQ(field.getInterval(), (iir::Interval{ast::Interval::Start, ast::Interval::Start, 0, 2}));
}
