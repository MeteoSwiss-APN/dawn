    ...
    body_ast = sir_utils.make_ast(
        [
                ...
                [
                    sir_utils.make_assignment_stmt(
                        ...
                        sir_utils.make_binary_operator(
                            sir_utils.make_binary_operator(
                                sir_utils.make_field_access_expr("u_vert", [True, 0]),
                                "*",
                                sir_utils.make_field_access_expr("primal_normal_x", [True, 0]),
                            ),
                            "+",
                            sir_utils.make_binary_operator(
                                sir_utils.make_field_access_expr("v_vert", [True, 0]),
                                "*",
                                sir_utils.make_field_access_expr("primal_normal_y", [True, 0]),
                            ),
                        ),
                        "=",
                    )
                ...
                sir_utils.make_reduction_over_neighbor_expr(
                    ...
                    rhs=sir_utils.make_binary_operator(
                        sir_utils.make_binary_operator(
                            sir_utils.make_field_access_expr("u_vert", [True, 0]),
                            "*",
                            sir_utils.make_field_access_expr("dual_normal_x", [True, 0]),
                        ),
                        "+",
                        sir_utils.make_binary_operator(
                            sir_utils.make_field_access_expr("v_vert", [True, 0]),
                            "*",
                            sir_utils.make_field_access_expr("dual_normal_y", [True, 0]),
                        ),
                    ),
                    chain=[
                        SIR.LocationType.Value("Edge"),
                    ...
                    weights=[
                        ...
                        sir_utils.make_literal_access_expr("1.0", SIR.BuiltinType.Double),
                        sir_utils.make_literal_access_expr("0.0", SIR.BuiltinType.Double),
                        sir_utils.make_literal_access_expr("0.0", SIR.BuiltinType.Double),
                    ],
                ),
                "=",
            ...
            sir_utils.make_assignment_stmt(
                ...
                sir_utils.make_binary_operator(
                    sir_utils.make_field_access_expr("diff_multfac_smag"),
                    "*",
                    sir_utils.make_fun_call_expr(
                        "math::sqrt",
                        [
                            sir_utils.make_binary_operator(
                                sir_utils.make_field_access_expr("kh_smag_1"),
            ...
            sir_utils.make_assignment_stmt(
                ...
                sir_utils.make_reduction_over_neighbor_expr(
                    ...
                    init=sir_utils.make_literal_access_expr("0.0", SIR.BuiltinType.Double),
                    rhs=sir_utils.make_binary_operator(
                        sir_utils.make_literal_access_expr("4.0", SIR.BuiltinType.Double),
                        "*",
                        sir_utils.make_field_access_expr("vn_vert"),
                    ),
                    chain=[
            ...
            sir_utils.make_assignment_stmt(
                ...
                sir_utils.make_binary_operator(
                    ...
                    sir_utils.make_binary_operator(
                        sir_utils.make_binary_operator(
                            sir_utils.make_binary_operator(
                                sir_utils.make_literal_access_expr("8.0", SIR.BuiltinType.Double),
                                "*",
                                sir_utils.make_field_access_expr("vn"),
                            ),
                            "*",
                            sir_utils.make_binary_operator(
                                sir_utils.make_field_access_expr("inv_primal_edge_length"),
