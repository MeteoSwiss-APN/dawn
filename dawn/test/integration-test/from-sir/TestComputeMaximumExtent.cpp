...
TEST_F(TestComputeMaximumExtent, DISABLED_test_field_access_interval_02) {
...
TEST_F(TestComputeMaximumExtent, DISABLED_test_compute_maximum_extent_01) {
