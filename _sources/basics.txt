...
We suggest using the build system (CMake) for a smooth integration with your project. The installation of Dawn provides a find configuration script (which can be used with `find_package <https://cmake.org/cmake/help/v3.5/command/find_package.html>`_) that should be installed into your system.
...
to import all the necessary informations.
